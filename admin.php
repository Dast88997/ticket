...
$ust = isset($_GET['ust'])?$_GET['ust']:'';
$past = isset($_GET['past'])?$_GET['past']:'';
if($ust!='' && $past!='')
{
$name='';
$sql="select name,ust,mobile,email,past from huds where ust='$ust' and past='$past'";
$row=$conn->query($sql);
if($row->num_rows>0)
{
while($data=$row->fetch_assoc())
{
  ...
  $error="<h1>Invalid login details</h1>";
}
}
?>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <table>
                    <tr>
                        <td
                            style="border-left:1px solid #0000ff;border-top:1px solid #0000ff;border-right:1px solid #000000;border-bottom:1px solid #0000ff;background-color:#0000ff;width:200px;height:300px;">
                        ...
                        <td
                            style="border-left:1px solid #0000ff;border-top:1px solid #0000ff;border-right:1px solid #0000ff;border-bottom:1px solid #0000ff;background-color:#0000ff;width:500px;height:300px;">
                            <div class="grid" style="width:500px">
                                ...
                                <form action="" method="get">
                                    ...
                                    <div class="form__field">
                                        ...
                                        &nbsp <input autocomplete="username" id="login__username" type="text" name="ust"
                                    ...
                                    <div class="form__field">
                                        ...
                                        &nbsp <input id="login__password" type="password" name="past"
                            ...
                            <p style="text-align:center;font-size:13px;color:#ffffff;"> This Is A Copy Right &#169;  Centerpoint Travels 2019. All Rights Reserved.</p>
                        </td>
                    </tr>
                </table>
            </div>
