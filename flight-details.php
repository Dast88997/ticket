...
terminal4,a_abbre4,terms4,airline2,time_transit,final_arrival,checkin1,d_travel1,aircraft2,meal2,distance2,type,
current,initial,final,image,status,change_over_airport,change_over_abbre,change_over_time,airfare,boarding from details where ust='$ust' and past='$past'";
...
{?>
    ...
    <p style="text-align:center"><a href="generate-flight-ticket.php?email=<?=$email;?>&search=flight-ticket" class="btn btn-success"
