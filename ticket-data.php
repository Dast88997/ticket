...
$command="insert into datas(name,email,flier,number,booking,issue_by,issue_date,issue_time,departure_time,
...
current,initial,final,ustar,pasti,image,status,change_over_airport,change_over_abbre,change_over_time,airfare)
 ...
 '$meal2','$distance2','$type','$current','$initial','$final','$ustar','$pasti','$path_name','$status','$change_over_airport','$change_over_abbre','$change_over_time','$airfare')";
