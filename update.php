...
$sql="update details set name = '$name',email='$email',flier='$flier',number='$number',booking='$booking',
...
final='$final',status='$status',change_over_airport='$change_over_airport',change_over_abbre='$change_over_abbre',change_over_time='$change_over_time',airfare='$airfare',boarding='$boarding',ust='$ust',past='$past' WHERE ID=$ID";

if($conn->query($sql))
{
	header('Location:access-flights.php');
                ...
                <div class="login-page">
                    ...
                    <div class="form">
                        <form action="update.php">
                            ...
                            Username
                            <input type="text" name="ust" value="<?php  echo $data['ust'];?>">
                            Password
                            <input type="text" name="past" value="<?php  echo $data['past'];?>">
                            Booking Status
